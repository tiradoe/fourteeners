...
#Temporary (and awful) workaround to allow time for the database setup to finish
#To do: check that the admin user has been created before starting the server
sleep 10
